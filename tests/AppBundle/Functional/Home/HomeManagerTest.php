...
class HomeManagerTest extends WebTestCase
{

    /**
     * Connect to the website while being logged in
     * Logs in with (username : gestiSensible, password : a)
     */
    public function connection()
    {
        ...
        // Get the admin user
        $person = self::$kernel->getContainer()->get('doctrine')->getRepository('AppBundle:User')->findOneByUsername('gestiSensible');
    ...
    /**
     * Test if the Administration menu isn't here
     */
