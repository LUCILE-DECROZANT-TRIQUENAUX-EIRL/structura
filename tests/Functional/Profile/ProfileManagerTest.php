...
class ProfileManagerTest extends WebTestCase
{
    ...
    public function testSelectProfile()
    {
        ...
        $this->assertContains('Mix Tobie Soyer', $crawler->filterXPath('//h1')->text());
    ...
    public function testLogout()
    {
        ...
        $this->assertNotContains('gestiSensible', $crawler->filterXPath('//a')->text());
    }
